...
Everything here runs with **Python 3 and numpy** and nothing else. These are the methods the
handbook describes, in runnable form — read them alongside chapters 3, 4 and 6. Each file is executable and
